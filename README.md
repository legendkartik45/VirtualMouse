...
1.	Virtual Mouse Control Using Colored Fingertips and Hand Gesture Recognition. 	Vantukal Reddy, Thumma Dhyanchand, Galla Vamsi Krishna, Satish Maheshwaram	Hand Gesture Recognition, Image Processing, Neural Network Algorithm, Python OpenCV, pyautogui	Advantage: Used neural network for hand gesture recognition. 
...
These landmarks are processed and then send to keypoint_classifier.csv. This csv file is then used to train and test our model.

Data in keypoint_classifier.csv
...
We represent these classes with the numbers and are stored in Keypoint_classifier_csv.
...
2.	Virtual Mouse Control Using Colored Finger Tips and Hand Gesture Recognition
3.	Hand Gestures - Virtual Mouse for Human Computer Interaction 
4.	Virtual Mouse using Object Tracking, 2020 
5.	Abhik Banerjee, Abhirup Ghosh and Koustuvmoni Bharadwaj, "Mouse Control using a Web Camera based on Color Detection”
6.	A Review of the Hand Gesture Recognition System: Current Progress and Future Directions 
